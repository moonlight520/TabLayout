...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_tab.add("首页"); list_tab.add("微淘"); list_tab.add("生活");
        list_tab.add("购物车"); list_tab.add("我的淘宝");
    ...
    public void initFragment(){
        ...
        list_fragment.add(new TinyTaoFragment());
        list_fragment.add(new LiveFragment());
        list_fragment.add(new ShopCarFragment());
        list_fragment.add(new MyTaoBaoFragment());
